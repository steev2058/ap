...
class MobFormViewModel  @Inject constructor(private val appRepository: AppRepository) : BaseViewModel() {
    ...
    fun sendMobForm(): LiveData<Resource<MobForm>> =
        appRepository.sendMobForm(mobForm)
}